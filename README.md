...
```bash
edrgap --version
edrgap scan demos/                          # run against bundled demo
edrgap scan demos/ --format sarif --out r.sarif --fail-on high
edrgap mcp                                   # start as MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
- `demos/01-enterprise-200-endpoints/` — see [`SCENARIO.md`](demos/01-enterprise-200-endpoints/SCENARIO.md)
- `demos/02-acquisition-merge/` — see [`SCENARIO.md`](demos/02-acquisition-merge/SCENARIO.md)
- `demos/03-clean-shop/` — see [`SCENARIO.md`](demos/03-clean-shop/SCENARIO.md)
