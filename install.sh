#!/usr/bin/env sh
# Universal installer for edrgap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/edrgap.git"
echo "Installing edrgap ..."
